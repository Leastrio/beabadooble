...
Beabadooble.Repo.insert_all(
  ...
  [
    ...
    %{id: 4, name: "A Night To Remember", filename: "A Night To Remember - Beabadoobee.mp3", seconds: 233},
    %{id: 5, name: "tinkerbell is overrated", filename: "tinkerbell is overrated feat. PinkPantheress - Beabadoobee.mp3", seconds: 228},
    %{id: 6, name: "Last Day On Earth", filename: "Last Day On Earth - Beabadoobee.mp3", seconds: 222},
    ...
    %{id: 14, name: "the way things go", filename: "the way things go - Beabadoobee.mp3", seconds: 187},
    ...
    %{id: 17, name: "He Gets Me So High", filename: "He Gets Me So High - Beabadoobee.mp3", seconds: 165},
    ...
    %{id: 21, name: "the perfect pair", filename: "the perfect pair - Beabadoobee.mp3", seconds: 177},
    ...
    %{id: 31, name: "Yoshimi, Forest, Magdalene", filename: "Yoshimi, Forest, Magdalene - Beabadoobee.mp3", seconds: 204},
    ...
    %{id: 35, name: "The Man Who Left Too Soon", filename: "The Man Who Left Too Soon - Beabadoobee.mp3", seconds: 109},
    ...
    %{id: 40, name: "How Was Your Day?", filename: "How Was Your Day_ - Beabadoobee.mp3", seconds: 260},
    %{id: 41, name: "This Is How It Went", filename: "This Is How It Went - Beabadoobee.mp3", seconds: 214},
    ...
    %{id: 51, name: "Everything I Want", filename: "Everything I Want - Beabadoobee.mp3", seconds: 191},
    ...
    %{id: 55, name: "Winter Wonderland", filename: "Winter Wonderland - Beabadoobee.mp3", seconds: 182},
    ...
    %{id: 58, name: "You’re here that’s the thing", filename: "You’re here that’s the thing - Beabadoobee.mp3", seconds: 198},
    %{id: 59, name: "Back To Mars", filename: "Back To Mars - Beabadoobee.mp3", seconds: 90},
    %{id: 60, name: "It's Only A Paper Moon", filename: "It's Only A Paper Moon - Beabadoobee.mp3", seconds: 145},
    %{id: 61, name: "Real Man", filename: "Real Man - Beabadoobee.mp3", seconds: 160},
    %{id: 62, name: "You Lie All The Time", filename: "You Lie All The Time - Beabadoobee.mp3", seconds: 251},
    %{id: 63, name: "Home Alone", filename: "Home Alone - Beabadoobee.mp3", seconds: 140},
    %{id: 64, name: "Don’t get the deal", filename: "Don’t get the deal - Beabadoobee.mp3", seconds: 220},
    ...
    %{id: 69, name: "Beatopia Cultsong", filename: "Beatopia Cultsong - Beabadoobee.mp3", seconds: 151},
    %{id: 70, name: "The Way I Spoke", filename: "The Way I Spoke - Beabadoobee.mp3", seconds: 255},
    %{id: 71, name: "California", filename: "California - Beabadoobee.mp3", seconds: 172},
    %{id: 72, name: "I Wish I Was Stephen Malkmus", filename: "I Wish I Was Stephen Malkmus - Beabadoobee.mp3", seconds: 231},
